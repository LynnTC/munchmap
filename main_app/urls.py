...
urlpatterns = [
  ...
  path('restaurants/create/<str:id>', views.restaurant_create, name='restaurant_create'),
  ...
  path('profile/unfollow/<int:target_id>/', views.profile_unfollow_user, name='profile_unfollow_user'),
  path('profile/<int:target_id>/', views.profile_detail, name="profile_detail"),
  path('follow/<int:target_id>/', views.profile_follow_user, name="profile_follow_user"),
